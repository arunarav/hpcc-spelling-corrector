/*
The following sample implements Peter Norvig's spelling corrector. This initial version computes the corrected spelling
at a distance of 1.
...
Spelling_Check := correctTheSpelling('WOR');
